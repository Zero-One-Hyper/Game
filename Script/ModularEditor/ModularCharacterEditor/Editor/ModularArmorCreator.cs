        ...
        private List<BodyPartLinker> GetArmorParts(ModularArmorType armorType) {
            ...
            switch (armorType) {
                case ModularArmorType.Helmet:
                    armorParts.Add(new BodyPartLinker(ModularBodyPart.头部附件));
                    armorParts.Add(new BodyPartLinker(ModularBodyPart.头盔));
                    armorParts.Add(new BodyPartLinker(ModularBodyPart.头套));
                    armorParts.Add(new BodyPartLinker(ModularBodyPart.帽子));
                    armorParts.Add(new BodyPartLinker(ModularBodyPart.面具));
                    break;
                case ModularArmorType.Shoulders:
                    armorParts.Add(new BodyPartLinker(ModularBodyPart.左侧肩部附件));
                    armorParts.Add(new BodyPartLinker(ModularBodyPart.右侧肩部附件));
                    break;
                case ModularArmorType.Cloak:
                    armorParts.Add(new BodyPartLinker(ModularBodyPart.背部附件));
                    break;
                case ModularArmorType.Chest:
                    armorParts.Add(new BodyPartLinker(ModularBodyPart.躯干));
                    armorParts.Add(new BodyPartLinker(ModularBodyPart.左侧上臂));
                    armorParts.Add(new BodyPartLinker(ModularBodyPart.右侧上臂));
                    break;
                case ModularArmorType.Gloves:
                    armorParts.Add(new BodyPartLinker(ModularBodyPart.左侧手臂关节));
                    armorParts.Add(new BodyPartLinker(ModularBodyPart.右侧手臂关节));
                    armorParts.Add(new BodyPartLinker(ModularBodyPart.左侧下臂));
                    armorParts.Add(new BodyPartLinker(ModularBodyPart.右侧下臂));
                    armorParts.Add(new BodyPartLinker(ModularBodyPart.左手));
                    armorParts.Add(new BodyPartLinker(ModularBodyPart.右手));
                    break;
                case ModularArmorType.Legs:
                    armorParts.Add(new BodyPartLinker(ModularBodyPart.臀部_腰部));
                    armorParts.Add(new BodyPartLinker(ModularBodyPart.臀部_腰部附件));
                    break;
                case ModularArmorType.Boots:
                    armorParts.Add(new BodyPartLinker(ModularBodyPart.左侧膝盖));
                    armorParts.Add(new BodyPartLinker(ModularBodyPart.右侧膝盖));
                    armorParts.Add(new BodyPartLinker(ModularBodyPart.左脚));
                    armorParts.Add(new BodyPartLinker(ModularBodyPart.右脚));
                    break;
            }
            return armorParts;
        }
